...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/mastervectormaster/checkers/checkers/next_game
   */
  queryNextGame = (params: RequestParams = {}) =>
    this.request<CheckersQueryGetNextGameResponse, RpcStatus>({
      path: `/mastervectormaster/checkers/checkers/next_game`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/mastervectormaster/checkers/checkers/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<CheckersQueryParamsResponse, RpcStatus>({
      path: `/mastervectormaster/checkers/checkers/params`,
      method: "GET",
      format: "json",
      ...params,
    });
